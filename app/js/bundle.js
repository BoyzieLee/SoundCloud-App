...
function audioBar(obj) {
  return '\n  <div class="audioBar"><p></p></div>\n  ';
}

exports['default'] = audioBar;
...
var _audiobar = require('./audiobar');

var _audiobar2 = _interopRequireDefault(_audiobar);
...
var token = '3f4f6e443227c34b2391dcf6a71ba46a';
var url = 'https://api.soundcloud.com/tracks?client_id=' + token + '&limit=50';
...
},{"./audiobar":2,"./nowplaying":4,"./searchresults":5,"jquery":1}],4:[function(require,module,exports){
'use strict';
